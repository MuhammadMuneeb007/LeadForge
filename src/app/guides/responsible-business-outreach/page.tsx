...
export default function OutreachGuide() {
  return (
    <>
      ...
      />
      <ContentNav
        label="Responsible business outreach"
        parent={{ href: "/guides", label: "Guides" }}
      />
      <main className="data-page">
        <header className="data-hero">
          <p className="kicker">GUIDE</p>
          <h1>Using a public-data list without becoming the problem.</h1>
          <p>
        ...
        <div className="doc-body">
          <section>
            ...
            <p>
              ...
              number reaches anyone, that the e-mail address is monitored, or
              that anyone there has any interest in what you sell.
            </p>
            <p>
              ...
              two years ago scores exactly as well as one for a thriving
              practice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Verification is not a formality you can skip when the list is
              long. It is the step that decides whether your outreach is
              informed or embarrassing.
            </p>
            <ul>
              <li>
                <strong>Confirm the business exists as described.</strong> Open
                its website. Does the name match? Does the address match? Is
                there any sign the site has been maintained recently?
              </li>
              <li>
            ...
            <p>
              ...
              &ldquo;just in case&rdquo;. A short verified list outperforms a
              long unverified one on every measure that matters, including how
              you feel about sending it.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              business. Narrowing the list in the tool is faster than
              apologising later.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              actual capacity to follow up; do not send a second and third
              message to someone who did not respond to the first; and never
              disguise a bulk send as a personal one. If your message would be
              indistinguishable from every other message the recipient received
              that week, the list is not the problem.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              organisation. A named individual&rsquo;s work address, or a
              personal mobile that happens to appear on a small business&rsquo;s
              website, carries a stronger expectation of privacy even though
              both are technically public.
            </p>
            <p>
              ...
              exists. If contact discovery returns several addresses, choosing
              the role-based one is nearly always both the safer and the more
              effective option.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              send, and — this is where public-data workflows go wrong — apply
              it to <em>new</em> exports too. Because you can re-run the same
              radius search next quarter and get the same businesses back, an
              opt-out that lives only in a deleted spreadsheet will quietly stop
              working.
            </p>
            <p>
              Make opting out easy: a working reply address, a clear
              instruction, and no requirement to explain themselves. Where the
              law specifies how quickly you must act on a request, treat that as
              the deadline, not the target — and act immediately in practice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Marketing and privacy law varies widely. Depending on where you
              are and where your recipients are, obligations may cover the legal
              basis for contacting someone, whether prior consent is needed for
              particular channels, what identifying information a message must
              carry, how quickly opt-outs must be honoured, what records you
              must keep, whether a do-not-call registry must be checked before
              telephoning, and what rights individuals have over the data you
              hold about them.
            </p>
            <p>
              These rules can apply to you because of where your recipient is,
              not only where you are. They also change. We cannot tell you what
              ...
              outreach is significant in scale or crosses borders, get advice
              that is specific to your jurisdiction and your channel.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Alongside currency, practise minimisation. Keep only the fields
              you actually use — a phone list does not need coordinates, and a
              mail-merge does not need opening hours. Keep records only as long
              as you have a reason to. Delete campaign exports when the campaign
          ...
          <section>
            ...
            <p>
              The same restraint applies to the shared services this tool
              depends on. Rate limits and result caps exist because public map
              and tile services are community infrastructure. Working around
              them to extract data in bulk takes capacity away from everyone
              else, and it is prohibited by the terms of use.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Role-based contact addresses preferred over personal ones.
              </li>
              <li>
                Suppression list applied, including to newly exported rows.
              </li>
              <li>
                Sender identity accurate, opt-out path present and working.
              </li>
              <li>
                Volume proportionate to your ability to have a real
                conversation.
              </li>
              <li>
              ...
              <li>
                Your obligations checked for your jurisdiction and channel.
              </li>
            </ul>
          </section>
        </div>
